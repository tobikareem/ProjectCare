...
- Tasks: [Link to 03-tasks spec - created after this is approved]

---

## Executive Summary

> **One-sentence technical summary of the solution approach.**

Example: "Implement GPS-based check-in/out using .NET MAUI Geolocation API with SignalR real-time updates and EF Core entity tracking."
...
- [Tasks Spec](../03-tasks/[feature-name].md)
