...
Use this skill for CarePath's three-document spec-driven development workflow.

## Purpose

This command guides Codex through CarePath Health's Spec-Driven Development workflow, producing three linked spec documents for a new feature:
...
### CarePath-Specific Design Rules (from AGENTS.md)
