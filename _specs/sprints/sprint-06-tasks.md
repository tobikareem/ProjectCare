...
| S6-TASK-065 | Web Generate invoice: `/billing/generate` Select and explicit Preview states; server-paged client selector with defaults, caregiver/credential attribution, linked exclusions, read-only snapshot, Back/Edit, stale-preview recovery, confirmation, invoice-detail navigation and bUnit tests | Codex | S6-TASK-058 frozen handoff | Done 2026-07-17 — selection/preview/create, token clearing, stale re-preview, client/preview paging, body-only scoped exclusion drill-through, guarded invoice-detail navigation, Home/Billing entry points and bUnit coverage; Web 54 green, solution build 0 warnings; reviewer re-check clean |
| S6-TASK-063 | Web reconciliation: KPI cards, body-based filters/server paging, linked exclusion drill-through, shift/time/rate correction destinations, owning-invoice navigation, resolve/reopen confirmation, stale-PHI clearing, role gates, responsive/keyboard states and bUnit tests | Codex | S6-TASK-058 frozen handoff, S6-TASK-065 | In progress 2026-07-17 — KPI/search/detail, time correction, resolve/reopen, invoice/lifecycle routing, stale-PHI clearing, responsive states and tests implemented; `ShiftRateUpdate` cannot safely complete because frozen `ShiftDetailDto` excludes bill/pay rates and no protected rate-editor contract/page exists |
