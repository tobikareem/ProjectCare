...
public sealed class Sprint4ControllerContractTests
{
    ...
    [InlineData(typeof(CarePlansController), "GetCarePlan", "Admin,Coordinator,Clinician,Client,Caregiver")]
    ...
    [InlineData(typeof(InvoicesController), "PreviewInvoice", "Admin,Coordinator")]
    [InlineData(typeof(InvoicesController), "SearchReconciliation", "Admin,Coordinator")]
    [InlineData(typeof(InvoicesController), "GetReconciliationDetail", "Admin,Coordinator")]
    [InlineData(typeof(InvoicesController), "ResolveReconciliation", "Admin,Coordinator")]
    [InlineData(typeof(InvoicesController), "ReopenReconciliation", "Admin,Coordinator")]
    [InlineData(typeof(InvoicesController), "CorrectReconciliationTime", "Admin,Coordinator")]
    ...
    [InlineData(typeof(CarePlansController), "GetCarePlan", typeof(HttpGetAttribute), "{id:guid}")]
    ...
    [InlineData(typeof(InvoicesController), "PreviewInvoice", typeof(HttpPostAttribute), "preview")]
    [InlineData(typeof(InvoicesController), "SearchReconciliation", typeof(HttpPostAttribute), "reconciliation/search")]
    [InlineData(typeof(InvoicesController), "GetReconciliationDetail", typeof(HttpGetAttribute), "reconciliation/shifts/{shiftId:guid}")]
    [InlineData(typeof(InvoicesController), "ResolveReconciliation", typeof(HttpPostAttribute), "reconciliation/shifts/{shiftId:guid}/resolve")]
    [InlineData(typeof(InvoicesController), "ReopenReconciliation", typeof(HttpPostAttribute), "reconciliation/shifts/{shiftId:guid}/reopen")]
    [InlineData(typeof(InvoicesController), "CorrectReconciliationTime", typeof(HttpPostAttribute), "reconciliation/shifts/{shiftId:guid}/correct-time")]
